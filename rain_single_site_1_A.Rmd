...
rm(list=ls())
  ...
  single_site_name <- site_names[33]
  ...
  subfolder_names<-subfolder_names[24:32] # TESTING ONLY
...
## Rain Gauge: 34 Signal Hill

# NOTE: Years 2009 - 2010 were removed from the analysis (error on processing)
