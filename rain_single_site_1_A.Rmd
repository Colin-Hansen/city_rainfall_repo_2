...
## Rainfall Event Statistics - IET 60 Minutes
...
## Boxplot of Rainfall Event Depth, Duration (IET 60 Minutes)
...
```{r event-boxplot-part-1, eval=TRUE, echo = FALSE,message=FALSE, warning=FALSE}
  ...
  gathered_ddi_results <- ddi_list_combined %>% gather(key=Parameter,value=MIT.result,depth,duration,intensity)
    ...
    # boxplot of the three results
      ...
      chart_title<-paste0(site_prefix," ", "Rain Event Results MIT 60")
...
## Rainfall Event Statistics (IET 360 Minutes)
...
## Rainfall Maximum Gap Times - Inter-Event Time (IET) 60 Minutes
...
## Rainfall Gap Time Statistics - IET 60 Minutes
